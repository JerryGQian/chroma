...
public class CameraRenderer implements Runnable, TextureView.SurfaceTextureListener {
    ...
    public void run() {
        ...
        cameraFilterMap.append(R.id.filter1, new RedGreenFilter(context));
        cameraFilterMap.append(R.id.filter2, new BlueYellowFilter(context));
        cameraFilterMap.append(R.id.filter3, new RedGreenVRFilter(context));
        cameraFilterMap.append(R.id.filter4, new BlueYellowVRFilter(context));
